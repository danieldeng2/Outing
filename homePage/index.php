...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark sticky-top">
    <div class="container">
      ...
      <a class="navbar-brand" data-toggle="modal" data-target="#signInModalCenter">
        <img src="icons/account_circle-24px.svg" width="36" height="36" alt="My Info">
      </a>
      ...
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="input-group mb-3">
              <input type="text" class="form-control" name="eventDestination" placeholder="Destination">
            </div>
            ...
            <div class="input-group">
              <textarea class="form-control" aria-label="description" name="eventDescription" placeholder="Description"></textarea>
            </div>
        ...
        <form action="/" id="signInForm">
          ...
          <div class="modal-body">
            ...
            <div class="input-group mb-3">
              ...
              <input type="text" class="form-control" name="signInUserName" placeholder="required">
            </div>
            ...
            <div class="input-group mb-3">
              ...
              <input type="password" class="form-control" name="signInPassword" placeholder="required">
            </div>
          </div>
          <div class="modal-footer">
