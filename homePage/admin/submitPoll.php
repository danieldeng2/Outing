        ...
        <div class="card-body">
          ...
          foreach (json_decode($row[1]) as &$optionstext) {       
              ...
              <div class="progress mb-3 mt-1" >
                <div class="progress-bar" role="progressbar" style="width:'.((int) ($voteNum==0?0:$voteNum/($totalvote)*100)).'%" aria-valuenow="'.$voteNum.'" aria-valuemin="0" aria-valuemax="'.$totalvote.'"></div>
              </div> ';
              $j++;
          };
    echo '  
