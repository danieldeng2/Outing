...
<<<<<<< HEAD
		 ...
		 <script>
		   ...
		   function initMap() {
			 var options = {
				//Options
				zoom:8, //Zoom level
				center:{lat: 51.4988, lng:  0.1749} //Position of the center of the map
			 }
			 ...
			 //Adding marker
			 addMarker({coords:{lat: 51.4988, lng:  0.1749}, //coords
						iconImage:'icons/grey-map-marker.png'//icon image, use whatever you like
			 }); 
			 
			 //Adding marker
		     addMarker({coords:{lat: 52.4988, lng:  1.1749}});
			 
			 
			 //Add Marker function - requires a coord
			 function addMarker(props){
			 //Add marker
				var marker = new google.maps.Marker({
					position:props.coords,	//Position of the marker
					map:map, //what map to add the marker to.
					icon:props.iconImage //Gives the marker a specific icon
				});
			 }
		   }
		...
		<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyB6777HJL2P0R_KZ1RQ6RE3XiikaowzVN8&callback=initMap"
			async defer>
		</script>
...
>>>>>>> dynamic message skeleton done
		...
		<div class="card-body">
		  <h4 class="d-inline-block card-title">Event One</h4>
		  ...
		  <div class="col-lg-12 mt-4" style="margin: auto;">
		    ...
		    <div class="card-body">
              <p><img class="mb-1 mr-1" src="icons/calendar_today_black-24px.svg" width="20" height="15"><font size="4.5"><b>Time: </b> 2001-09-11 09:00:00</font></p>
              <p><img class="mb-1 mr-1" src="icons/location_on_black-24px.svg" width="20" height="15"><font size="4.5"><b>Location: </b> World Trade Centre</font></p>
			  
			  <p class="card-text">Please pay Osama Bin Laden $100.00 for providing the bombs.</p>
              <p class="card-text">Payment Info: 696969 420420</p>
            </div>
